...
public class SalonServiceManagementController {
    ...
    public ResponseEntity<Void> changeSalonServiceVisibility(@PathVariable Long serviceId, @PathVariable Boolean isActive) {
    ...
    public ResponseEntity<Void> updateSalonService(@Valid @RequestBody SalonServiceDTO salonServiceDTO, @PathVariable Long serviceId) {
